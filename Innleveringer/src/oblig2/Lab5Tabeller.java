...
public class Lab5Tabeller {
		...
		public static int[] reverser(int[] tabell) {
			...
			// som gitt en tabell av heltall returnerer en ny tabell som har de samme elementene som tabell men i motsatt rekkefølge.
		...
		public static boolean erSortert(int[] tabell) {
			...
			// som kan avgjere om ein array (tabell) av heiltal er sortert stigande (dvs. at alle tall skal vere større enn det forrige)
